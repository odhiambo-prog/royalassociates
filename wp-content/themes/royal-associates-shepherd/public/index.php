      ...
      <div class="u-content v-flex-8">
        <div class="content-flex v-flex-6">
          ...
          <div data-speed="50s" class="ticker-wrap is-offices">
            <div class="ticker-contain"><div class="ticker-coll-wrap is-offices"><div class="ticker-coll-list is-offices"><?php $__renderSet(); ?></div></div></div>
            <div class="ticker-contain"><div class="ticker-coll-wrap is-offices"><div class="ticker-coll-list is-offices"><?php $__renderSet(); ?></div></div></div>
          </div>
          <?php endif; ?>
        </div>
