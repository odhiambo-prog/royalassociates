...
<div class="hero-slider-bgs" style="position:absolute;inset:0;z-index:0">
  <div class="hero-slide-bg is-active" style="position:absolute;inset:0;background-image:url(/assets/images/hero-images/personal-insurance.jpg);background-size:cover;background-position:center;background-repeat:no-repeat;opacity:1;transition:opacity 0.8s ease"></div>
  <div class="hero-slide-bg" style="position:absolute;inset:0;background-image:url(/assets/images/hero-images/corporate1.jpg);background-size:cover;background-position:center;background-repeat:no-repeat;opacity:0;transition:opacity 0.8s ease"></div>
</div>
