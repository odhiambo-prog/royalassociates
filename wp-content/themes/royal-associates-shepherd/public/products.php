...
(function(){
  ...
  window.showQuoteModal = function(name){
    var ov = document.getElementById('quote-modal');
    if(ov){
      var pf = ov.querySelector('.gf-product-field input');
      if (pf) { pf.value = name || ''; pf.readOnly = true; }
      ov.classList.add('active');
      var first = ov.querySelector('input[name="name"]');
