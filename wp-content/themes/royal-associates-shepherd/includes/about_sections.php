...
function about_parse_team_filename(string $filename): array
{
    ...
    $known = [
        ...
        'Linda_Gladys_Langat' => ['Linda Gladys Langat', 'HR, Administration & Healthcare Executive'],
        'Pheneahs_Kinyua' => ['Pheneahs Kinyua', 'Operations Manager'],
        'Rachael_Mueni_Mwangangi' => ['Rachael Mueni Mwangangi', 'Head of Finance'],
        ...
        'Samson_Maingi' => ['Samson Maingi', 'Underwriting & Claims/General Executive'],
        'Daniel_Kahindi' => ['Daniel Kahindi Njeri', 'Business Development'],
        'Elizabeth_Odero' => ['Elizabeth Odero', 'Administration'],
        'Joseph_Kaanywa' => ['Joseph Kaanywa', 'Finance'],
        'Njeri_Maureen_Mutuku' => ['Maureen Mutuku', 'Office Administration, Machakos Branch'],
