...
module.exports = function(options)
{
	...
	this.each(function()
	{
		...
		this.infinite_scroll_result_class = $this.attr('data-infinite-scroll-result-class'); //for load more only, once we detect we're at the end set this to true
		...
		this.onWindowScroll = function(event)
		{
			if((!self.is_loading_more) && (!self.is_max_paged))
			{
				...
				if(self.$infinite_scroll_container.length==1)
				{
					...
					if(window_scroll_bottom + scroll_offset > results_scroll_bottom)
					{
		...
		this.getUrlParams = function(keep_pagination, type)
		{
			if(typeof(keep_pagination)=="undefined")
			{
		...
		this.setAjaxResultsURLs = function(query_params)
		{
            ...
            //console.log("extra ajax query params");
            //console.log(self.extra_query_params['ajax']);
