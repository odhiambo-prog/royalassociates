...
* Performance - when generating forms with many options
...
* Performance - improved the speed of rebuilding the cache for a particular post - this improves the speed of S&F when saving posts in admin as well as the overall caching speed when the cache has been reset
