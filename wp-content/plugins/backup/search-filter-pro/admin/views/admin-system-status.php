	...
	<table class="widefat" cellspacing="0" id="status">
		...
		<tbody>
			...
			<tr>
				...
				<td><?php echo esc_html( Search_Filter::VERSION ); ?></td>
			</tr>
			<?php /*<!--<tr>
		...
		<tbody>
			...
			<?php
				...
				$response = wp_safe_remote_post( 'https://www.paypal.com/cgi-bin/webscr', array(
					'timeout'    => 60,
					'user-agent' => 'Search_Filter/' . Search_Filter::VERSION,
					'body'       => array(
	...
	<tbody>
		...
		<tr>
			...
			<?php	
				...
				$search_form_fields = (get_post_meta( $search_form->ID, $meta_key, true ));
				$filters = array();
		...
		<tr>
			...
			<?php
				...
				//as we only want to update "enabled", then load all settings and update only this key
				$search_form_settings = (get_post_meta( $search_form->ID, $meta_key, true ));
